...
- **`design`** — finished Technical Design draft and which repo to check. Check data structures, this repo's boundary rules, naming/UI, and this side of any cross-repo integration claim against `repos.md`. Also check every rule in `.opencode/design-rules.md` that applies to this draft.
